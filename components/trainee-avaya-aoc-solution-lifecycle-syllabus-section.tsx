...
export function TraineeAvayaAocSolutionLifecycleSyllabusSection({ sections }: Props) {
  return (
    <TraineeCourseSyllabusSection
      title="Avaya AOC Solution Lifecycle syllabus for your assignment"
      syllabusFilePath="courses/avaya-aoc-solution-lifecycle/syllabus.md"
      body={
        <>
