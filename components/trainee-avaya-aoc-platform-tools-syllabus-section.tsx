...
export function TraineeAvayaAocPlatformToolsSyllabusSection({ sections }: Props) {
  return (
    <TraineeCourseSyllabusSection
      title="Avaya AOC Platform Tools & Automation syllabus for your assignment"
      syllabusFilePath="courses/avaya-aoc-platform-tools-automation/syllabus.md"
      body={
        <>
