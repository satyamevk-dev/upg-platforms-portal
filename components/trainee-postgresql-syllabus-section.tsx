...
export function TraineePostgresqlSyllabusSection({ sections }: Props) {
  return (
    <TraineeCourseSyllabusSection
      title="PostgreSQL syllabus for your assignment"
      syllabusFilePath="courses/postgresql/syllabus.md"
      body={
        <>
          . Tracks are grouped by syllabus level (Basic, Intermediate, Advanced). Only tiers that include at least one
          of your plan&apos;s PostgreSQL modules are shown. Each syllabus topic has one module guide and one end-of-topic
