...
export function TraineeNetworkingSyllabusSection({ sections }: Props) {
  return (
    <TraineeCourseSyllabusSection
      title="Networking syllabus for your assignment"
      syllabusFilePath="courses/networking/syllabus.md"
      body={
        <>
          . Tracks are grouped by syllabus level (Basic, Intermediate, Advanced). Only tiers that include at least one
          of your plan&apos;s Networking modules are shown. Each syllabus topic has one module guide and one end-of-topic
          ...
          <span className="font-medium text-[#177F78]">In your plan</span> match your assigned topics; others show
