...
export function TraineeLinuxSyllabusSection({ sections }: Props) {
  return (
    <TraineeCourseSyllabusSection
      title="Linux syllabus for your assignment"
      syllabusFilePath="courses/linux/syllabus.md"
      body={
        <>
          . Tracks are grouped by syllabus level (Basic, Intermediate, Advanced). Only tiers that include at least one
          of your plan&apos;s Linux modules are shown. Each syllabus topic has one module guide and one end-of-topic
