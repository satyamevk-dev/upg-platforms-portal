...
**Track:** Solution lifecycle · **Module ID:** `aocsl-plan`

## Overview

This module aligns with the training library topic **Plan & govern**. Work through the lessons, try examples in a lab or sandbox, and use the quiz to confirm understanding before moving on.
